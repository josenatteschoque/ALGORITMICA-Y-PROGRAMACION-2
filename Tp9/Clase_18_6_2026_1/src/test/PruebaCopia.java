...
public class PruebaCopia {
	...
	public static void main(String[] args) {
		...
		// shortestPathLengths (Que implementa Dijkstra) necesita un grafo con éste formato 
		...
		for (Edge<Camino> result : g.edges()) {
			...
			gd.insertEdge(res.get(vert[0].getElement()), res.get(vert[1]
					.getElement()), result.getElement().getDistancia());
		}
