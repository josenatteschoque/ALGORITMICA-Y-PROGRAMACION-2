...
public class Prueba {
	...
	public static void main(String[] args) {
		...
		//Si es false es no dirigido y si es true es dirigido
		...
		System.out.println("N�mero de v�rtices: " + g.numVertices());
		System.out.println("N�mero de arcos: " + g.numEdges());
		...
		System.out.println("N�mero de arcos salen del vertice V1: "
				+ g.outDegree(v1));
		System.out.println("N�mero de arcos llegan al vertice V4: "
				+ g.inDegree(v4));
