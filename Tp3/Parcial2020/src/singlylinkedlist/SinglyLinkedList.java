...
//Funciona siuuu :)
	...
	public void removePos(int pos, int nro) {
		//Excepciones
		if(pos < 1) throw new IndexOutOfBoundsException("La posicion debe de ser mayor o igual a 1");
		if(pos > size) throw new IndexOutOfBoundsException("La posicion no puede ser mayor a tamaño!");
		if(pos + nro - 1 > size) {
	        throw new IndexOutOfBoundsException("No hay suficientes elementos para eliminar");
	    }
